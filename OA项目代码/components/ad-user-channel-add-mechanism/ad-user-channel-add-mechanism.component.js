 ...
 * 添加机构信息
 */
angular.module('byComponent').component('adUserChannelAddMechanism', {
    templateUrl: '../components/ad-user-channel-add-mechanism/ad-user-channel-add-mechanism.template.html',
