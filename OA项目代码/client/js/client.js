...
var clientApp = angular.module("clientApp", ["ui.router", "ui.bootstrap", "w5c.validator", "mix.service", "mix.directive", "mix.filter", "ngFileUpload", "project.service", "byComponent", "angular-input-stars", 'angular-loading-bar']);

// 配置表单验证
clientApp.config(function (w5cValidatorProvider) {
    // 全局配置
...
//配置loading
clientApp.config(configuredLoadingBar);
...
clientApp.controller("commonCtrl", function ($scope, signOut) {
...
//菜单控制器
clientApp.controller("menuController", function ($scope, queryData, signOut) {
    $scope.menuOptions = [
        {
            name: '项目管理',
